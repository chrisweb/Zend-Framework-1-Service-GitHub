...
/**
 * Chrisweb Service GitHub for Zend Framework 1
 *
 * LICENSE
 *
 ...
 */
class Chrisweb_Service_GitHub extends Zend_Rest_Client
{
     ...
     * 
     * @param String $path
     * @return \Chrisweb_Service_GitHub
     */
    ...
    public function query()
    {
        ...
        if (!is_null($response)) {
            ...
            if (!is_string($response)) {
                ...
                require_once 'Chrisweb/Service/GitHub/Exception.php';
                throw new Chrisweb_Service_GitHub_Exception($response);
            }

        } else {
            require_once 'Chrisweb/Service/GitHub/Exception.php';
            throw new Chrisweb_Service_GitHub_Exception('the response we recieved is emtpy');
        }
        ...
        try {
            ...
            require_once 'Chrisweb/Service/GitHub/Exception.php';
            throw new Chrisweb_Service_GitHub_Exception('JSON decoding failed: '.$exception->getMessage());
        }
        ...
        if ($status != '200') {
            require_once 'Chrisweb/Service/GitHub/Exception.php';
            throw new Chrisweb_Service_GitHub_Exception('we recieved an error ('.$status.') as response: '.$result['message']);
        }
    ...
    protected function _getResponse()
    {
        ...
        if (empty($this->_path)) {
            require_once 'Chrisweb/Service/GitHub/Exception.php';
            throw new Chrisweb_Service_GitHub_Exception('Path must be set before performing call, use setPath() to set one.');
        }
